...
### Features
- [x] Remove old ballot generation loading animation — the "Building Your Guide" screen with 6 stars and loading messages now only shows for 1-2 seconds since SSE streaming populates races directly on the ballot page. Either remove it entirely and go straight to the ballot view, or simplify to a brief spinner.
