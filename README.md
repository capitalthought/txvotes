...
worker/tests/
├── 28 test files      # 2219+ tests (vitest + happy-dom)
worker/public/
...
2219+ tests across 28 test files covering interview flows, guide generation, routing, multi-state config, DC address resolution, bias detection, token budgets, audit scoring, rate limiting, SSE streaming, post-election phase guards, public stats, and more.
